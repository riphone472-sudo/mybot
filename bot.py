...
async def city_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    buttons = [
        [InlineKeyboardButton(" CK 🥇Gold🥇 (🥇) 0.3 g 3450₽", callback_data=f"product_{city}")],
...
async def product_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await query.message.reply_text(
        ...
        f"Город / Shahar: {city}\n\n"
        f"Товар / Mahsulot: CK 🥇Gold🥇 (🥇)0.3g 3450₽\n\n"
...
async def region_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    buttons = [
        [InlineKeyboardButton("LTC *к оплате*/to'lov uchun: 0.8829437", callback_data=f"pay_{city}_{region}")],
        [InlineKeyboardButton("🔙 Главное меню", callback_data="main_menu")]
    ]
...
async def payment_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "➖➖➖➖➖➖➖➖ \n"
        "💎 TO PAY: 0.8829437 LTC\n\n"
        "🎁 Product: CK 🥇Gold🥇 (🥇)0.3g 3450₽ \n\n"
